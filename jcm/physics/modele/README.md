...
4. Port the cloud-base **mass flux** (`MASS_FLUX2`: the closure magnitude given
   instability/TKE and the adjustment timescale) -- the first piece that yields
   a nonzero rate -- then wire trigger + closure into `GissConvection.__call__`.
